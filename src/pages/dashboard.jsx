...
import { useGetDashbordStatsQuery } from "../redux/slices/api/taskApiSlice";
...
if (!data || !data.users) {
  ...
  const stats = [
  {
    _id: "1",
    label: "TOTAL TASK",
    total: data && data.totalTasks ? data.totalTasks : 0, // Check if data and data.totalTasks are defined before accessing
    icon: <FaNewspaper />,
    bg: "bg-[#1d4ed8]",
  },
  {
  ...
  },
  {
    ...
    total: totals && totals["in progress"] ? totals["in progress"] : 0, // Check if totals and totals["in progress"] are defined before accessing
  ...
  },
  {
    _id: "4",
    label: "TODOS",
    total: totals && totals["todo"] ? totals["todo"] : 0, // Check if totals and totals["todo"] are defined before accessing
    icon: <FaArrowsToDot />,
    bg: "bg-[#be185d]",
  },
];
